   ...
   <section className='parallax aux-historia'> 
        <Container className='py-5  media-aux'>
            ...
            <div> 
                ...
                <Row className='py-4'>
                    <Col className='d-flex justify-content-center'>
                        <Card  style={{ width:'100%', maxWidth: '23rem', backgroundColor:'#22347c' }}>
                            <Card.Body>
                ...
                <Row className='py-4'>
                    <Col className='d-flex justify-content-center'>
                        <Card  style={{ width:'100%', maxWidth: '18rem', backgroundColor:'#22347c' }}>
                            <Card.Body>
                ...
                <Row className='py-4'>
                    <Col className='d-flex justify-content-center'>
                        <Card  style={{ width:'100%', maxWidth: '18rem', backgroundColor:'#0493dd' }}>
                            <Card.Body>
                    ...
                    <Col className='d-flex justify-content-center'>
                        <Card  style={{ width:'100%', maxWidth: '18rem', backgroundColor:'#0493dd', color:'white !important' }}>
                            <Card.Body>
                                <Card.Title > <h3 className='text-subt '>VOCAL SUPLENTE 4</h3></Card.Title>
                                <Card.Text className='text-p text-center'>
                                    Gaston Dreyer
                                </Card.Text>
                                <Card.Text className='text-p text-center'>
